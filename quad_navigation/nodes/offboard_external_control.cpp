...
public:
	OffboardControl() : Node("offboard_control_external") {
	...
	~OffboardControl() {
		publish_enable_external_controller(false);
	}
...
private:
	...
	void publish_enable_external_controller(bool enable) const;
...
/**
 * @brief Enable External Control.
 */
void OffboardControl::publish_enable_external_controller(bool enable) const {
...
int main(int argc, char* argv[]) {
	std::cout << "Starting external offboard control node..." << std::endl;
